...
export class IncomeStatementTool extends SimpleReportTool<typeof IncomeStatementInputSchema> {
  ...
  protected buildArgs(input: z.infer<typeof IncomeStatementInputSchema>): string[] {
