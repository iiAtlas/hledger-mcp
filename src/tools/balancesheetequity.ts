...
export class BalanceSheetEquityTool extends SimpleReportTool<typeof BalanceSheetEquityInputSchema> {
  ...
  protected buildArgs(input: z.infer<typeof BalanceSheetEquityInputSchema>): string[] {
